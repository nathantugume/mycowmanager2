...
class ActivityRepository{
  final FirestoreRepository<Activity> _activityRepo = FirestoreRepository<Activity>(
    collectionName: 'activities',
    fromJson: (json) => Activity.fromJson(json),
    toJson: (c) => c.toJson(),

  );
  Future<List<Activity>> getAll() async => _activityRepo.getAll();        // returns Future
  Future<void> add(Activity c)             => _activityRepo.add(c);
