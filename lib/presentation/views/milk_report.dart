              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    final farmName =
                        context.read<CurrentFarm>().farm?.name ?? 'Farm';
    ...
    return RepaintBoundary(
      ...
      child: Padding(
        ...
        child: SfCartesianChart(
          ...
          title: ChartTitle(text: 'Milk Production'),
          legend: Legend(isVisible: false),
          tooltipBehavior: TooltipBehavior(enable: true),
          series: <CartesianSeries<MilkStat, String>>[
            ColumnSeries<MilkStat, String>(
              dataSource: stats,
              xValueMapper: (MilkStat s, _) => s.period,
              yValueMapper: (MilkStat s, _) => s.litres,
              name: 'Litres',
  ...
  Widget build(BuildContext context) {
    return RepaintBoundary(
      ...
      child: Padding(
        ...
        child: SfCartesianChart(
          primaryXAxis: CategoryAxis(),
          title: ChartTitle(text: 'Milk Trend'),
          legend: Legend(isVisible: false),
          tooltipBehavior: TooltipBehavior(enable: true),
          series: <CartesianSeries<MilkStat, String>>[
            LineSeries<MilkStat, String>(
              dataSource: stats,
              xValueMapper: (MilkStat s, _) => s.period,
              yValueMapper: (MilkStat s, _) => s.litres,
              name: 'Litres',
      ...
      pw.Page(
        build: (pw.Context ctx) {
          return pw.Column(
            ...
            children: [
              pw.Text(
                '$farmName  Milk Report (${filter.label})',
                style: pw.TextStyle(
                  fontSize: 18,
